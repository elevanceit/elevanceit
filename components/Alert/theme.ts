...
export const AlertTheme = tv({
  ...
  variants: {
    variant: {
      ...
      secondary: "border-secondary-500 bg-secondary-500 text-secondary-800 dark:text-secondary-200",
      success: "border-success-500 border-opacity-10 bg-success-500 bg-opacity-10 text-success-800",
